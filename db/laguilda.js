export default {
	...
	bio: [
		...
		{
			name: 'Fernando María',
			bio: 'La guitarra flamenca de Fernando María bebe directamente de la escuela sevillana, ciudad en la que nació y desde la que principalmente desarrolla su actividad como guitarrista. Su toque personal ha conseguido impregnarse de los sones más carismáticos del Flamenco pudiendo reconocer su gusto por los maestros de la Guitarra Flamenca. No obstante, en busca de su sello personal ha ido incorporando características de otros estilos musicales, como el gusto por la calidad del sonido de la guitarra clásica barroca, la apertura rítmica de la guitarra contemporánea latinoamericana o el estudio armónico de  la guitarra de jazz. Su actividad como guitarrista la desarrolla principalmente como acompañante, bien del cante o del baile.'
		},
		{
			name: 'Isa Rodriguez',
			bio: 'Comenzó a tocar la batería en el 2006 estudiando con profesores como David López, José Mena, Jimmy González y Antonio Coronel. Ha colaborado desde entonces en diferentes grupos del panorama sevillano y ha acompañado a artistas como la Húngara y en grabaciones y directos para el artista local Pedro Jiménez. Batería en Rocktámbulos desde 2014 hasta la fecha. Festival flamenco de Nimes en el espectáculo "Guitarra mía" acompañando a artistas de la talla de Rocío Molina de la mano de su padre el guitarrista flamenco Rafael Rodríguez. Espectáculo "Off Limits" en el festival de danza de Itálica, julio 2017.'
		},
		{
			name: 'Shaula Ortega',
			bio: 'Licenciada en Bellas Artes, la trayectoria artística de Shaula Ortega va ligada indefectiblemente al desarrollo digital y las numerosas posibilidades audiovisuales. Su trabajo entabla un dialogo directo entre la naturaleza de la existencia humana y la complejidad de las estructuras sociales. Por ello, al tiempo que desarrolla su labor como artista visual independiente, ha formado parte de Compañías de Baile Flamenco y Danza así como de espectáculos y eventos musicales de toda orden.'
		},
		{
			name: 'Enrique López de Haro',
			bio: 'Realizó estudios de Escenografía, Dirección Escénica y Arquitectura en Sevilla, su ciudad natal, Berlín y Barcelona, disciplinas que sigue compaginando.  Actualmente desarrolla su actividad escénica en laGuilda Obscénica cuya primera producción ha sido Offlimits.'
		},
		{
			name: 'Alberto del Valle',
